            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-4">
                        <Link to="/about" className="text-xs text-zinc-400 hover:text-zinc-100 transition-colors">About Me</Link>
                        <a href="mailto:vroan21@gmail.com" className="text-xs text-zinc-400 hover:text-zinc-100 transition-colors">Contact</a>
